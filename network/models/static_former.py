...
class ConstructEgo(nn.Module):
    ...
    def __init__(self, d_k=128, _M=5, c=5, T=30, L_enc=1, dropout=0.0, k_attr=2, map_attr=3,
                 num_heads=16, L_dec=1, tx_hidden_size=384):
    ...
    def forward(self, ego_in, agents_in, roads, constructions):
        '''
        ...
        #self.construction_encoder(constructions, ego_soctemp_emb)
        ...
        for d in range(self.L_dec):
            if d == 1:
                #print("Input shape: {}".format(out_seq.shape))
                ...
                #print("Ouput shape: {}".format(out_seq.shape))
                """
