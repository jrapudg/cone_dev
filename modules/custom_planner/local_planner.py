...
import numpy as np
import copy
from modules.custom_planner import path_optimizer
from modules.custom_planner import collision_checker
from modules.custom_planner import velocity_planner
from math import sin, cos, pi, sqrt

class LocalPlanner:
    def __init__(self, num_paths, path_offset, circle_offsets, circle_radii,
                 path_select_weight, time_gap, a_max, slow_speed,
                 stop_line_buffer, carla_map):
